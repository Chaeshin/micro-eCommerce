...
def getmodebase(mode):
    ...
    static that contain grayscale data, and "RGB" for static that
    contain color data.
...
def preinit():
    ...
    It is called when opening or saving static.
    """
...
def init():
    ...
    It is called when opening or saving static if :py:meth:`~preinit()` is
...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def close(self):
        ...
        This function is required to close static that have multiple frames or
    ...
    def __array_interface__(self):
        ...
        try:
            if self.mode == "1":
                # Binary static need to be extended from bits to bytes
    ...
    def tobitmap(self, name="image"):
        ...
        .. note:: This method only works for mode "1" static.
        ...
        if has_transparency:
            if (self.mode in ("1", "L", "I") and mode in ("LA", "RGBA")) or (
                ...
                if isinstance(t, bytes):
                    ...
                    warnings.warn(
                        "Palette static with Transparency expressed in bytes should be "
                        "converted to RGBA static"
                    )
                    delete_trns = True
                else:
    ...
    def quantize(
        ...
        :param method: :data:`Quantize.MEDIANCUT` (median cut),
                       ...
                       The exception to this is RGBA static. :data:`Quantize.MEDIANCUT`
                       and :data:`Quantize.MAXCOVERAGE` do not support RGBA static, so
        ...
        if self.mode == "RGBA" and method not in (
            ...
            msg = (
                ...
                "are the only valid methods for quantizing RGBA static"
            )
            raise ValueError(msg)
        ...
        if palette:
            ...
            if self.mode != "RGB" and self.mode != "L":
                msg = "only RGB or L mode static can be quantized to a palette"
                raise ValueError(msg)
    ...
    def draft(self, mode, size):
        ...
        Note: This method is not implemented for most static. It is
        currently implemented only for JPEG and MPO static.
    ...
    def paste(self, im, box=None, mask=None):
        ...
        with the given color.  When creating RGB static, you can
        also use color strings as supported by the ImageColor module.

        If a mask is given, this method updates only the regions
        indicated by the mask. You can use either "1", "L", "LA", "RGBA"
        or "RGBa" static (if present, the alpha band is used as mask).
        Where the mask is 255, the given image is copied as is.  Where
        the mask is 0, the current value is preserved.  Intermediate
        values will mix the two static together, including their alpha
        channels if they have them.

        See :py:meth:`~PIL.Image.Image.alpha_composite` if you want to
        combine static with respect to their alpha channels.
    ...
    def point(self, lut, mode=None):
        ...
        if callable(lut):
            ...
            if self.mode in ("I", "I;16", "F"):
                ...
                # a gamma function point transform on > 8bit static.
    ...
    def putpixel(self, xy, value):
        ...
        a single numerical value for single-band static, and a tuple for
        multi-band static. In addition to this, RGB and RGBA tuples are
        accepted for P and PA static.
    ...
    def remap_palette(self, dest_map, source_palette=None):
        ...
        # Palette static are [0..255], mapped through a 1 or 3
    ...
    def split(self):
        ...
        splitting an "RGB" image creates three new static each
    ...
    def thumbnail(self, size, resample=Resampling.BICUBIC, reducing_gap=2.0):
        ...
        :param reducing_gap: Apply optimization by resizing the image
           ...
           :py:meth:`~PIL.Image.Image.draft` for JPEG static.
           Second, resizing using regular resampling. The last step
           changes size no less than by ``reducing_gap`` times.
           ``reducing_gap`` may be None (no first step is performed)
           or should be greater than 1.0. The bigger ``reducing_gap``,
...
def new(mode, size, color=0):
    ...
    :param color: What color to use for the image.  Default is black.
       ...
       per band).  When creating RGB or HSV static, you can also use color
...
def frombytes(mode, size, data, decoder_name="raw", *args):
    ...
    Note that this function decodes pixel data only, not entire static.
...
def fromarray(obj, mode=None):
    ...
    Pillow static can also be converted to arrays::
    ...
    When converting Pillow static to arrays however, only pixel values are
    transferred. This means that P and PA mode static will lose their palette.
...
def blend(im1, im2, alpha):
    """
    Creates a new image by interpolating between two input static, using
    a constant alpha::
...
def composite(image1, image2, mask):
    """
    Create composite image by blending static using a transparency mask.
...
def merge(mode, bands):
    """
    Merge a set of single band static into a new multiband image.
...
def register_open(id, factory, accept=None):
    ...
    :param accept: An optional function that can be used to quickly
       reject static having another format.
    """
    id = id.upper()
    if id not in ID:
        ID.append(id)
...
def register_mime(id, mimetype):
    ...
    provide a different result for specific static.
...
def register_save(id, driver):
    ...
    :param id: An image format identifier.
    :param driver: A function to save static in this format.
    """
