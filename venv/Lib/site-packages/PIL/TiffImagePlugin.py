...
OPEN_INFO = {
    ...
    (II, 6, (1,), 1, (8,), ()): ("L", "L"),
    (MM, 6, (1,), 1, (8,), ()): ("L", "L"),
    # JPEG compressed static handled by LibTiff and auto-converted to RGBX
    # Minimal Baseline TIFF requires YCbCr static to have 3 SamplesPerPixel
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _seek(self, frame):
        ...
        while len(self._frame_pos) <= frame:
            if not self.__next:
                msg = "no more static in TIFF file"
                raise EOFError(msg)
            logger.debug(
    ...
    def _setup(self):
        ...
        # old style jpeg compression static most certainly are YCbCr
        ...
        if self.use_load_libtiff:
            ...
            # so large g4 static will fail if we use that
            # function.
            #
            ...
            # YCbCr static with new jpeg compression with pixels in one plane
...
def _save(im, fp, filename):
    ...
    # required for color libtiff static
