...
# 1998-07-12 fl   Read/write 16-bit static as mode I (0.4)
...
# 2008-08-13 fl   Added tRNS support for RGB static
    ...
    def seek(self, frame):
        ...
        for f in range(self.__frame + 1, frame + 1):
            try:
                ...
                msg = "no more static in APNG file"
...
def _save(im, fp, filename, chunk=putchunk, save_all=False):
    ...
    if mode == "P":
        #
        # attempt to minimize storage requirements for palette static
